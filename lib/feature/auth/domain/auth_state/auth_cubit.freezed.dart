...
class _$_AuthStateNotAuthorized implements _AuthStateNotAuthorized {
  const _$_AuthStateNotAuthorized({final String? $type})
...
class _$_AuthStateAuthorized implements _AuthStateAuthorized {
  const _$_AuthStateAuthorized(this.userEntity, {final String? $type})
...
class _$_AuthStateWaiting implements _AuthStateWaiting {
  const _$_AuthStateWaiting({final String? $type}) : $type = $type ?? 'waiting';
...
class _$_AuthStateError implements _AuthStateError {
  const _$_AuthStateError(this.error, {final String? $type})
      : $type = $type ?? 'error';
